...
namespace Myshop.Web.Migrations
{
    ...
    [Migration("20240921210341_updateSessionIdandPaymentId")]
    partial class updateSessionIdandPaymentId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Myshop.Web.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Myshop.Web.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Myshop.Web.Models.OrderHeader", b =>
                {
                    b.HasOne("Myshop.Web.Models.AppUser", "AppUser")
                        .WithMany()
